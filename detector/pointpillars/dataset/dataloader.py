...
def collate_fn(list_data):
    ...
    for data_dict in list_data:
        ...
        batched_image_list.append(torch.from_numpy(image))
        bathced_gt_result_list.append(gt_result)
    ...
    rt_data_dict = dict(
        ...
        batched_image=batched_image_list,
        batched_gt_result=bathced_gt_result_list
    )
